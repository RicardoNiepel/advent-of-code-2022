...
def create_range(elf_string):
    (start, end) = elf_string.split("-")
    return range(int(start), int(end)+1) # +1 because we need inclusive ranges
